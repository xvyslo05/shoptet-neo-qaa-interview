...
| TC-NAMEDAY-053 | AC5, AC7.a, AC11.a | Scenario | P2 | e2e | auto | Submit invalid date → error shown; click Reset → error cleared (`e2e/cypress/e2e/nameday_lookup.cy.ts`); submit today's date | Error shown, then cleared by Reset, then replaced by the correct result |
